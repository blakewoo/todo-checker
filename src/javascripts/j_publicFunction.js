exports.requestFunction = function (method_type,url,send_data,responseType="JSON",callback) {
...
exports.okCancelModal = function (message,width=400,height=200,callback) {
...
exports.yesNoModal = function (message,width=400,height=200,callback) {
    let html = document.getElementsByTagName("html")[0]
